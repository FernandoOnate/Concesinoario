...
export class RolUsuarioController {
  ...
  async find(
    ...
    return this.rolRepository.esta_asociado_a(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.esta_asociado_a(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.esta_asociado_a(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.esta_asociado_a(id).delete(where);
  }
}
