...
export class MarcaVehiculoController {
  ...
  async find(
    ...
    return this.marcaRepository.tiene_vehiculos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.marcaRepository.tiene_vehiculos(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.marcaRepository.tiene_vehiculos(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.marcaRepository.tiene_vehiculos(id).delete(where);
  }
}
