...
export class ProveedorVehiculoController {
  ...
  async find(
    ...
    return this.proveedorRepository.tiene_vehiculos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.proveedorRepository.tiene_vehiculos(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.proveedorRepository.tiene_vehiculos(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.proveedorRepository.tiene_vehiculos(id).delete(where);
  }
}
