...
export class VendedorUsuarioVendedorController {
  ...
  async get(
    ...
    return this.vendedorRepository.tiene_uno(id).get(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.tiene_uno(id).create(usuarioVendedor);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.tiene_uno(id).patch(usuarioVendedor, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.tiene_uno(id).delete(where);
  }
}
