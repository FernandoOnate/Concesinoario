...
export class VentasFacturaController {
  ...
  async get(
    ...
    return this.ventasRepository.tiene_factura(id).get(filter);
  }
  ...
  async create(
    ...
    return this.ventasRepository.tiene_factura(id).create(factura);
  }
  ...
  async patch(
    ...
    return this.ventasRepository.tiene_factura(id).patch(factura, where);
  }
  ...
  async delete(
    ...
    return this.ventasRepository.tiene_factura(id).delete(where);
  }
}
